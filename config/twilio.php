<?php
    ...
    return [
        'twilio' => [
            'url' => env('TWILIO_URL', 'https://api.twilio.com'),
            'sid' => env('TWILIO_SID', 'ACcb48f3a256fc761e85c317e25bb831a2'),
            'token' => env('TWILIO_TOKEN', '665d85e7f68ac630d48ff195252945fe'),
            'number' => env('TWILIO_NUMBER', '2392968674|8557505972'),
        ],
        'svg' => [
